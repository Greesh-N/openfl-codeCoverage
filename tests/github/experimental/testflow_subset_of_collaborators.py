...
def flflow():
    ...
    return TestFlowSubsetCollaborators(checkpoint=True, random_ints=random_ints)

def testflow_subset_of_collaborators(flflow):
    ...
    for round_num in range(len(collaborators)):
        ...
        subset_collaborators = flflow.subset_collabrators
